...
class InitialCompanySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = collect([
            ...
            ['name' => 'Visualizar campanhas', 'slug' => 'campaigns.view'],
            ['name' => 'Gerenciar campanhas', 'slug' => 'campaigns.manage'],
            ...
            ['name' => 'Visualizar CRM', 'slug' => 'crm.view'],
            ['name' => 'Gerenciar CRM', 'slug' => 'crm.manage'],
