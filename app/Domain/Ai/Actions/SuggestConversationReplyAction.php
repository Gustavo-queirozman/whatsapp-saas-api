...
class SuggestConversationReplyAction
{
    ...
    public function execute(Conversation $conversation, ?User $user = null): AiExecutionResultData
    {
        ...
        if (trim($context->transcript) === '') {
            throw ValidationException::withMessages([
                'conversation' => 'A conversa nao possui mensagens com conteudo textual para sugerir resposta.',
            ]);
        }

        return $this->aiService->suggestReply($conversation, $context, $user?->id);
    }
}
